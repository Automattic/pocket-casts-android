...
class VideoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // The playing stream — not the episode's static file type — decides whether there is video.
        // Switching to an audio source resolves to AudioOnly, so close and hand back to the audio player.
