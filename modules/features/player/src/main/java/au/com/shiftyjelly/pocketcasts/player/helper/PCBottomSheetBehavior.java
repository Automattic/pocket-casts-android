 ...
 */
public class PCBottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    public PCBottomSheetBehavior(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        ...
        if (hasBackgroundTint) {
            ColorStateList bottomSheetColor = ColorStateList.valueOf(Color.TRANSPARENT);
    ...
    public boolean onTouchEvent(
            @NonNull CoordinatorLayout parent, @NonNull V child, @NonNull MotionEvent event) {
        if (!child.isShown() || !isDragEnabled) {
            return false;
        }
        int action = event.getActionMasked();
    ...
    View findScrollingChild(View view) {
        ...
        if (view instanceof ViewPager2) {
            ...
            RecyclerView.ViewHolder viewHolder = ((RecyclerView)viewPager.getChildAt(0)).findViewHolderForAdapterPosition(viewPager.getCurrentItem());
            View currentViewPagerChild = null;
            if (viewHolder != null) {
                currentViewPagerChild = viewHolder.itemView;
            }
    ...
    protected static class SavedState extends AbsSavedState {
        ...
        public SavedState(Parcelable superState, @NonNull PCBottomSheetBehavior<?> behavior) {
            super(superState);
        ...
        /**
         * This constructor does not respect flags: {@link PCBottomSheetBehavior#SAVE_PEEK_HEIGHT}, {@link
         * PCBottomSheetBehavior#SAVE_FIT_TO_CONTENTS}, {@link PCBottomSheetBehavior#SAVE_HIDEABLE}, {@link
         * PCBottomSheetBehavior#SAVE_SKIP_COLLAPSED}. It is as if {@link PCBottomSheetBehavior#SAVE_NONE}
         * were set.
         *
         * @deprecated Use {@link SavedState (Parcelable, PCBottomSheetBehavior )} instead.
         */
        @Deprecated
    ...
    /**
     * A utility function to get the {@link PCBottomSheetBehavior} associated with the {@code view}.
     *
     * @param view The {@link View} with {@link PCBottomSheetBehavior}.
     * @return The {@link PCBottomSheetBehavior} associated with the {@code view}.
     */
    @NonNull
    @SuppressWarnings("unchecked")
    public static <V extends View> PCBottomSheetBehavior<V> from(@NonNull V view) {
