...
import au.com.shiftyjelly.pocketcasts.player.databinding.FragmentContentEffectsBinding
...
@AndroidEntryPoint
class AllPodcastsEffectFragment : BaseDialogFragment(), CompoundButton.OnCheckedChangeListener, MaterialButtonToggleGroup.OnButtonCheckedListener, View.OnClickListener {
    ...
    private var binding: FragmentContentEffectsBinding? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentContentEffectsBinding.inflate(inflater, container, false)
