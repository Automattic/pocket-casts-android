...
private val DefaultColors = ColorProviders(
    light = ColorScheme(
        ...
        surfaceBright = UndefinedColor,
        surfaceDim = UndefinedColor,
        surfaceContainer = UndefinedColor,
        surfaceContainerHigh = UndefinedColor,
        surfaceContainerHighest = UndefinedColor,
        surfaceContainerLow = UndefinedColor,
        surfaceContainerLowest = UndefinedColor,
        primaryFixed = UndefinedColor,
        primaryFixedDim = UndefinedColor,
        onPrimaryFixed = UndefinedColor,
        onPrimaryFixedVariant = UndefinedColor,
        secondaryFixed = UndefinedColor,
        secondaryFixedDim = UndefinedColor,
        onSecondaryFixed = UndefinedColor,
        onSecondaryFixedVariant = UndefinedColor,
        tertiaryFixed = UndefinedColor,
        tertiaryFixedDim = UndefinedColor,
        onTertiaryFixed = UndefinedColor,
        onTertiaryFixedVariant = UndefinedColor,
    ),
    dark = ColorScheme(
        primary = UndefinedColor,
        onPrimary = UndefinedColor,
