...
internal class ArchiveAfterPlayingFragment : BaseDialogFragment() {
    ...
    override fun onCreateView(
        ...
        DialogBox(
            ...
            SelectedOptionColumn(
                title = getString(LR.string.settings_archive_played),
                options = AutoArchiveAfterPlaying.All,
                selectedOption = podcast?.autoArchiveAfterPlaying,
                optionLabel = { option -> stringResource(option.stringRes) },
                onClickOption = { option ->
                    viewModel.changeAutoArchiveAfterPlaying(option)
                    dismiss()
                },
