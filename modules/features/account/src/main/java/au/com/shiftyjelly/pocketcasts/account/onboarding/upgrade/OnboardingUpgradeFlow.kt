...
fun OnboardingUpgradeFlow(
    ...
    if (FeatureFlagManager.isFeatureEnabled(FeatureFlag.ADD_PATRON_ENABLED) && userSignedInOrSignedUpInUpsellFlow) {
        activity?.let {
            LaunchedEffect(Unit) {
    ...
    val startInExpandedState =
        ...
        hasSubscriptions && (
            ...
            (!FeatureFlagManager.isFeatureEnabled(FeatureFlag.ADD_PATRON_ENABLED) && userSignedInOrSignedUpInUpsellFlow) ||
