...
class ShowNotesFormatter(settings: Settings?, private val context: Context) {
    ...
    private fun addShowNotesHead(html: StringBuilder) {
        ...
        html.append("@font-face { font-family: 'Roboto-Medium'; src: url('fonts/Roboto-Medium.ttf'); } \n")
        html.append("@font-face { font-family: 'Roboto-Regular'; src: url('fonts/Roboto-Regular.ttf'); } \n")
        html.append("body, h1, h2, h3, h4, h5, h6 { font-family: 'Roboto-Regular'; font-weight: 400; word-wrap:break-word; font-size:").append(fontSize).append("px; line-height: ").append(lineHeight)
            .append("em; color:").append(textColor).append("; background-color: ").append(backgroundColor).append("; ").append(" } \n")
        html.append(".pageHeader { font-family: 'Roboto-Medium'; margin: 16px 0 4px 0; padding: 0 0 0 0  } \n")
