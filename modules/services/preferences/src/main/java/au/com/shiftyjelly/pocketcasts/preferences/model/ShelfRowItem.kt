...
enum class ShelfItem(
    ...
    val analyticsValue: ShelfActionType,
) : ShelfRowItem {
    Effects(
        id = "effects",
    ...
    Sleep(
        ...
        analyticsValue = ShelfActionType.SleepTimer,
    ),
    Star(
        id = "star",
        ...
        analyticsValue = ShelfActionType.StarEpisode,
    ),
    Share(
        id = "share",
    ...
    AddToPlaylist(
        ...
        analyticsValue = ShelfActionType.AddToPlaylist,
    ),
    Download(
        id = "download",
        titleId = {
        ...
        subtitleId = { episode -> LR.string.player_actions_hidden_for_custom.takeIf { episode is UserEpisode } },
        showIf = { it is PodcastEpisode },
        analyticsValue = ShelfActionType.Download,
    ),
    Transcript(
        id = "transcript",
