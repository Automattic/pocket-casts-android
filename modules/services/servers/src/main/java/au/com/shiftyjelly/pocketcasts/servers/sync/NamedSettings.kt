...
data class ChangedNamedSettings(
    ...
    @field:Json(name = "gridLayoutGlobal") val gridLayout: NamedChangedSettingInt? = null,
    ...
    @field:Json(name = "autoArchiveIncludesStarredGlobal") val autoArchiveIncludesStarred: NamedChangedSettingBool? = null,
    ...
    @field:Json(name = "volumeBoostGlobal") val volumeBoost: NamedChangedSettingBool? = null,
    @field:Json(name = "rowActionGlobal") val rowAction: NamedChangedSettingInt? = null,
    ...
    @field:Json(name = "filesAutoUpNextGlobal") val addFileToUpNextAutomatically: NamedChangedSettingBool? = null,
    @field:Json(name = "theme") val theme: NamedChangedSettingInt? = null,
    @field:Json(name = "badgesGlobal") val podcastBadges: NamedChangedSettingInt? = null,
