...
object DownloadHelper {
    ...
    fun manuallyDownloadEpisodeNow(episode: Episode, from: String, downloadManager: DownloadManager, episodeManager: EpisodeManager) {
    ...
    fun addAutoDownloadedEpisodeToQueue(episode: Episode, from: String, downloadManager: DownloadManager, episodeManager: EpisodeManager) {
    ...
    fun removeEpisodeFromQueue(episode: Episode, from: String, downloadManager: DownloadManager) {
        downloadManager.removeEpisodeFromQueue(episode, from)
    }

    @Throws(StorageException::class)
    fun pathForEpisode(episode: Episode, fileStorage: FileStorage): String? {
        val file = fileStorage.getPodcastEpisodeFile(episode)
        return file.absolutePath
    }

    @Throws(StorageException::class)
    fun tempPathForEpisode(episode: Episode, fileStorage: FileStorage): String {
