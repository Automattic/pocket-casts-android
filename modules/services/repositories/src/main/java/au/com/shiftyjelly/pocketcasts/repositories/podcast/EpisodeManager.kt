...
interface EpisodeManager {
    ...
    suspend fun markAsPlaybackError(episode: BaseEpisode?, errorMessage: String?)
    suspend fun markAsPlaybackError(episode: BaseEpisode?, event: PlayerEvent.PlayerError, isPlaybackRemote: Boolean)
    ...
    suspend fun clearPlaybackError(episode: BaseEpisode?)
