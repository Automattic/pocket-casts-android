...
class TranscriptManagerTest {
    ...
    fun `sanitize loaded transcript entries`() = runTest {
        ...
        parsers.getValue(TranscriptType.Vtt).entries = listOf(
            ...
            TranscriptEntry.Text("Two  or      more spaces."),
            TranscriptEntry.Text(""),
            TranscriptEntry.Speaker("\t\n  Empty space padding.\n\t  "),
            TranscriptEntry.Speaker("Any   \n\t  white       \n\nspace."),
            TranscriptEntry.Speaker(""),
        )
        ...
        assertEquals(
            listOf(
                ...
                TranscriptEntry.Text("Three\n\nor\n\nmore empty lines."),
                TranscriptEntry.Text("Two or more spaces."),
                TranscriptEntry.Speaker("Empty space padding."),
                TranscriptEntry.Speaker("Any white space."),
            ),
    ...
    @Test
    fun `remove repeated speakers in transcript entries`() = runTest {
        localTranscriptsFlow.value = listOf(vttDbTranscript)
        parsers.getValue(TranscriptType.Vtt).entries = listOf(
            ...
            TranscriptEntry.Text("Text 3."),
            TranscriptEntry.Speaker("Speaker 2"),
            TranscriptEntry.Text("Text 4."),
            TranscriptEntry.Speaker("Speaker 1"),
            TranscriptEntry.Text("Text 5."),
        )
    ...
    @Test
    fun `join split sentences across different entries`() = runTest {
        localTranscriptsFlow.value = listOf(vttDbTranscript)
        parsers.getValue(TranscriptType.Vtt).entries = listOf(
            TranscriptEntry.Text("Text 1. Text 2"),
            TranscriptEntry.Text("Text 3!"),
            TranscriptEntry.Text("Text 4? Text 5! Text 6. Text 7"),
            TranscriptEntry.Text("Text 8"),
            TranscriptEntry.Text("Text 9. Text 10"),
            TranscriptEntry.Text("Text 11"),
        )
        ...
        assertEquals(
            listOf(
                TranscriptEntry.Text("Text 1."),
                TranscriptEntry.Text("Text 2 Text 3!"),
                TranscriptEntry.Text("Text 4? Text 5! Text 6."),
                TranscriptEntry.Text("Text 7 Text 8 Text 9."),
                TranscriptEntry.Text("Text 10 Text 11"),
            ),
            (transcript as Transcript.Text).entries,
        )
    }
