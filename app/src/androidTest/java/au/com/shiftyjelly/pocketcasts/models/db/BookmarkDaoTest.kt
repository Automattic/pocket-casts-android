...
class BookmarkDaoTest {
    ...
    @Test
    fun testFindByEpisodeSortCreatedAtAsc() = runTest {
    ...
    @Test
    fun testFindByEpisodeSortCreatedAtDesc() = runTest {
        val bookmark1 = FakeBookmarksGenerator.create(createdAt = Date(2000))
        val bookmark2 = FakeBookmarksGenerator.create(createdAt = Date(3000))
        val bookmark3 = FakeBookmarksGenerator.create(createdAt = Date(1000))
        bookmarkDao.insert(bookmark1)
    ...
    @Test
    fun testFindByEpisodeSortTimeAsc() = runTest {
    ...
    @Test
    fun testSearchInPodcastByBookmarkTitle() = runTest {
    ...
    @Test
    fun testSearchInPodcastByEpisodeTitle() = runTest {
    ...
    @Test
    fun testFindByPodcastSortCreatedAtAsc() = runTest {
        val bookmark1 = FakeBookmarksGenerator.create(createdAt = Date(2000))
        val bookmark2 = FakeBookmarksGenerator.create(createdAt = Date(3000))
        val bookmark3 = FakeBookmarksGenerator.create(createdAt = Date(1000))
        bookmarkDao.insert(bookmark1)
    ...
    @Test
    fun testFindByPodcastSortCreatedAtDesc() = runTest {
        val bookmark1 = FakeBookmarksGenerator.create(createdAt = Date(2000))
        val bookmark2 = FakeBookmarksGenerator.create(createdAt = Date(3000))
        val bookmark3 = FakeBookmarksGenerator.create(createdAt = Date(1000))
        bookmarkDao.insert(bookmark1)
    ...
    @Test
    fun testFindByPodcastSortEpisodePublishDateAndBookmarkTime() = runTest {
